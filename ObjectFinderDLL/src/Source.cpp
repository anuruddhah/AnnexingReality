...
main(int argc, char** argv)
{
	...
	pcl::PointCloud <pcl::PointXYZ>::Ptr colored_cloud = (new pcl::PointCloud<pcl::PointXYZ>)->makeShared();
	pcl::PointXYZ point;
	...
	colored_cloud->width = strongest_peaks.size();

	pcl::visualization::PCLVisualizer viewer("3D Viewer");
	viewer.setBackgroundColor(0, 0, 0);
	viewer.initCameraParameters();

	viewer.addPointCloud<pcl::PointXYZ>(testing_cloud, "cloud");
	viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "cloud");
	viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 1.0, 1.0, 1.0, "cloud");

	viewer.addPointCloud<pcl::PointXYZ>(colored_cloud, "points");
	viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 5, "points");
	viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 1.0, 0.0, 0.0, "points");

	pcl::PointCloud <pcl::PointXYZ>::Ptr mug = (new pcl::PointCloud<pcl::PointXYZ>)->makeShared();
	pcl::io::loadPCDFile <pcl::PointXYZ>("cylinder.pcd", *mug);
	viewer.addPointCloud<pcl::PointXYZ>(mug, "mug");
	viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "mug");
	viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 1.0, 1.0, 0.0, "mug");
